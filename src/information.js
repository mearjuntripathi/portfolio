...
import design from "./images/icon-dev.svg";
import dev from "./images/icon-dev.svg";
import api from "./images/icon-dev.svg";
import cloud from "./images/icon-dev.svg";
...
import project12Image from './images/project-12.png';
import project13Image from './images/project-13.png';
...
const Introduction = {
    ...
    github: 'https://github.com/mearjuntripathi',
    linkedin: 'https://www.linkedin.com/in/mearjuntripathi/',
    google: 'https://g.dev/mearjuntripathi'
}
    ...
    service: [
        {
            name: "Programming",
            icon: design,
            about: `I'm as good as in Programming to problem solving and code <b>DSA</b>, and <b>System Design</b>`
        },
        {
            name: "Web development",
            icon: dev,
            about: `High-quality development of sites at the professional level.`
        },
        {
            name: "APIs",
            icon: api,
            about: `Good to develop in API for backend projects with <b>GOlang</b>, <b>Node JS</b>.`
        },
        {
            name: "Cloud Computing",
            icon: cloud,
            about: `I am capable to work in cloud Computing technology using <b>AWS</b>, <b>Azure</b>.`
        }
    ],
...
const ResumeData = {
    ...
    Education: [
        ...
        {
            title: "Mahatma Gandhi Kashi Vidhyapeeth",
            session: "2019 — 2022",
            about: `Bachelor of Computer Application
                <br>
                <b>73 %</b>`
        }
    ],
    Skills: [
        {
            ...
            skill: ["C", "C++", "Java", "JavaScript", "PHP", "GO", "HTML/CSS", "Node JS"]
        },
        {
